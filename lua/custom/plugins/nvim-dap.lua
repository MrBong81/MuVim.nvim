return {
  {
    ...
    config = function()
      ...
      -- local opts = { noremap = true, silent = true, desc = 'TEST' }
      ...
      vim.keymap.set('n', '<leader>do', function()
        dap.step_over()
      end, { noremap = true, silent = true, desc = '[D]ebug [O]ver' })

      -- Step Into
      vim.keymap.set('n', '<leader>di', function()
        dap.step_into()
      end, { noremap = true, silent = true, desc = '[D]ebug [I]nto' })

      -- Step Out
      vim.keymap.set('n', '<leader>dO', function()
        dap.step_out()
      end, { noremap = true, silent = true, desc = '[D]ebug [0]ut' })
